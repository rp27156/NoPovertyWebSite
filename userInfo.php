...
$q = "select * from userinfotable where name = '$name' && pwd = '$pwd'";
$result = mysqli_query($con,$q);
$num = mysqli_num_rows($result);
if($num ==1){
  echo " ";
  echo "Already present in database ! Enter another credentials to register";
}else{
  $query = " insert into userinfotable (name, email, mobile, pwd)
